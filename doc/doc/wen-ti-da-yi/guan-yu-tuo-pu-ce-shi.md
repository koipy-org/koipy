...
![作者 NetworkTopologies.png: Maksim / 衍生作品: Malyszkz - 基于如下对象的个人作品： NetworkTopologies.png，公有领域，https://commons.wikimedia.org/w/index.php?curid=15006915](../../.gitbook/assets/NetworkTopologies.svg)
...
![多IP结果解析示意图](../../.gitbook/assets/image%20%282%29.png)

### 双栈测试

如果一个域名能够被DNS服务器解析出IPV4和IPV6地址，那么会在拓扑结果图中栈显示为数字4和6

![双栈结果解析示意图（红色框部分）](../../.gitbook/assets/image%20%284%29.png)
...
![节点复用示意图（三个节点出口IP均相同，来自两个入口）](../../.gitbook/assets/image.png)
...
![编号27和28的节点不可用，被合并的示意图](../../.gitbook/assets/image%20%281%29.png)
